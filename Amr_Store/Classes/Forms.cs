...
namespace Motaz_Store
{
    public static class Forms
    {
        ...
        // Error
        public static ErrorForm errorForm = new ErrorForm() { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };

        // Reports
        public static ReportsForm reports = new ReportsForm() { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };

        public static Sells_Exs sells_Exs = new Sells_Exs() { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
        public static Sells_FPrice sells_FPrice = new Sells_FPrice() { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
